// const GEOJSON_API_URL = "https://opendata.stadt-xxx-1.de/sites/default/files/Tausch-und-Spende-Angebote-in-xxx-12024.geojson";
const GEOJSON_LOCAL_PATH = "./geojson.json";
const CITY_COORDS = [51.9607, 7.6261];
const WORKER_URL = "https://reuseme.xxx-3.workers.dev/";
...
async function setMap() {
  ...
  L.tileLayer('https://tile.openstreetmap.org/{z}/{x}/{y}.png', {
    maxZoom: 19,
    attribution: '&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a> | <a href="https://opendata.stadt-xxx-1.de/dataset/liste-der-orte-zum-spenden-verkaufen-tauschen-xxx-1">opendata.stadt-xxx-1.de</a>'
  }).addTo(map);
